...
class UE(Base):
    ...
    def outside_coverage(self):
        p = (self.position_x, self.position_y, self.position_z)
        d1_serve = math.dist(p, (self.serving_satellite.position_x, self.serving_satellite.position_y, self.serving_satellite.position_z))
