...
POS_SATELLITES = {
     1: (-2*SATELLITE_R, 0, 0),
     2: (-2*SATELLITE_R - HORIZONTAL_DISTANCE , 0, 0),
     3: (-2*SATELLITE_R - 2*HORIZONTAL_DISTANCE, 0, 0),
...
RRC_RANDOM_ACCESS = "RRC_RANDOM_ACCESS"
RRC_ULGRANT = "RRC_ULGRANT"
...
PROCESSING_TIME = {
    ...
    HANDOVER_REQUEST_ACKNOWLEDGE: 0.3 * CPU_SCALE,
    RRC_RANDOM_ACCESS: 0.2 * CPU_SCALE,
    RRC_ULGRANT: 0.2 * CPU_SCALE,
...
WAITING_RRC_ULGRANT = "WAITING_RRC_ULGRANT"
