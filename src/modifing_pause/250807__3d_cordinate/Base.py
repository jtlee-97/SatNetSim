...
class Base:
    ...
    def __init__(self,
        ...
        self.position_x = position_x  # 3D 맵에서의 x 좌표
        self.position_y = position_y  # 3D 맵에서의 y 좌표
        self.position_z = position_z  # 3D 맵에서의 z 좌표
    ...
    def init(self):
        ...
        print(f"{self.type} {self.identity} deployed at time {self.env.now}, positioned at ({self.position_x},{self.position_y},{self.position_z})")
