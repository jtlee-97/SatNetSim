...
# Message Type 별 Processing Time
PROCESSING_TIME = {
...
SATELLITE_TX_POWER_DBM = 23  # 위성 송신 전력 (dBm)
UE_ANTENNA_GAIN_DBI = 0      # 단말기 안테나 이득 (dBi)
SATELLITE_ANTENNA_GAIN_DBI = 10 # 위성 안테나 이득 (dBi)
CARRIER_FREQUENCY_MHZ = 2000 # 중심 주파수 (MHz)
